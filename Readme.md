...
#### TODOs
[] Create a simple tcp connection which can be used to send data to the server which resembles the registry
[] Create a simple tcp client which can be used to bombard the registry
